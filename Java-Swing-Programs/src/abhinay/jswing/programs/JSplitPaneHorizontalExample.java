...
public class JSplitPaneHorizontalExample extends JFrame {
	...
	public JSplitPaneHorizontalExample() {
		setTitle("JSplitPane Example");
		setSize(400, 400);
		getContentPane().setLayout(new FlowLayout());
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		JLabel splitPanelLabel = new JLabel("Horizontal JSplitPane");
		...
		JSplitPane horizontalSplitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, fruitsPanel, electronicsPanel);
	...
	public static void main(String[] args) {
		new JSplitPaneHorizontalExample();
	}
