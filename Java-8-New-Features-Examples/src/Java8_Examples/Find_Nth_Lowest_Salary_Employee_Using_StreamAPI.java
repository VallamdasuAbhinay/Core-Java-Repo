...
public class Find_Nth_Lowest_Salary_Employee_Using_StreamAPI {
	...
	public static void main(String[] args) {
		...
		findNthLowestEmployeeSalary(4, employeesList);
	}

	/*
	 * This approach is the effective one because even if there are multiple
	 * employees with the same lowest salary, then this method will print all of
	 * them
	 */
	public static void findNthLowestEmployeeSalary(int num, List<EmployeeClass> employeesList) {
