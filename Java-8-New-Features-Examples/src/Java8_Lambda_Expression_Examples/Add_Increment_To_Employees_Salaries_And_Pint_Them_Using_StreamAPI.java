...
public class Add_Increment_To_Employees_Salaries_And_Pint_Them_Using_StreamAPI {
	...
	public static void main(String[] args) {
		...
		employeesList.stream().map(emp -> emp.getSalary() + incrementAmount).forEach(f -> System.out.println(f));
