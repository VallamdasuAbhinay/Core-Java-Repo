...
public class Calculate_Sum_Of_Integers_Using_Lambda_Expression {
	...
	public static void main(String[] args) {
		...
		FunctionalInterface_CalculateSum abhinaySum = (x, y) -> (x + y);
 ...
 * Explanation:
 * 
 * In the above exercise, a functional interface named FunctionalInterface_CalculateSum is defined.
 ...
 * 
 * In the main method, an instance of the FunctionalInterface_CalculateSum interface is created using
