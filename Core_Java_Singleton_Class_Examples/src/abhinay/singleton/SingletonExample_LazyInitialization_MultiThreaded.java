...
public class SingletonExample_LazyInitialization_MultiThreaded {
	/*
	...
	public static void main(String[] args) {
		SingleTonHelperLazyMultiThreaded instance_1 = SingleTonHelperLazyMultiThreaded.getInstance();
		System.out.println("Hashcode of instance_1 is: " + instance_1.hashCode());
		SingleTonHelperLazyMultiThreaded instance_2 = SingleTonHelperLazyMultiThreaded.getInstance();
		System.out.println("Hashcode of instance_2 is: " + instance_2.hashCode());
		SingleTonHelperLazyMultiThreaded instance_3 = SingleTonHelperLazyMultiThreaded.getInstance();
		System.out.println("Hashcode of instance_3 is: " + instance_3.hashCode());
	}
}

class SingleTonHelperLazyMultiThreaded {

	private static SingleTonHelperLazyMultiThreaded singleton_instance;;

	private SingleTonHelperLazyMultiThreaded() {
		System.out.println("SingleTonHelperLazyMultiThreaded Constructor Called....");
	}

	public static synchronized SingleTonHelperLazyMultiThreaded getInstance() {
		if (singleton_instance == null) {
			singleton_instance = new SingleTonHelperLazyMultiThreaded();
		}
